...
### This file contains the Boosting of Decision Tree Classification using AdaboostingClassifier.
...
#### For values estimators = 50 to 400, the training is being done and tested the accuracy on validation dataset.
x
accr_training = []
error_training = []
